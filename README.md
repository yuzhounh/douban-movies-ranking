...
GitHub Pages 按“选电影、选剧集、分类排行榜”三个板块展示数据；每个板块可以继续选择顶层标签、筛选类别和具体标签。Top 250 位于“分类排行榜”板块。表格展示排序后的 `id`、`title`、`rating` 和 `rating_count`，点击任意影视条目所在行即可打开对应豆瓣页面，并支持分类内搜索与分页：
